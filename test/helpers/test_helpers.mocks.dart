...
// in mtihani_app/test/helpers/test_helpers.dart.
...
/// A class which mocks [TeacherOnboardingService].
///
/// See the documentation for Mockito's code generation for more information.
class MockTeacherOnboardingService extends _i1.Mock
  ...
  @override
  bool get isFromOnboarding => (super.noSuchMethod(
        Invocation.getter(#isFromOnboarding),
        returnValue: false,
        returnValueForMissingStub: false,
      ) as bool);

  @override
  set isFromOnboarding(bool? _isFromOnboarding) => super.noSuchMethod(
        Invocation.setter(
          #isFromOnboarding,
          _isFromOnboarding,
        ),
