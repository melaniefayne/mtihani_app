...
class StudentListSection extends StackedView<StudentListSectionModel> {
  ...
  StudentListSectionModel viewModelBuilder(
    BuildContext context,
      ...
      StudentListSectionModel(classroom);
}

// class StudentListWidget extends StatelessWidget {
//   final List<StudentClassModel> studentList;
//   final Function(StudentClassModel exam) onViewStudent;
...
//                   StudentClassModel student = studentList[idx];
//                   return StudentCard(
//                     student: student,
//                     onTap: onViewStudent,
//                     showTermScore: showTermScore,
