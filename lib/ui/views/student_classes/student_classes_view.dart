...
import 'package:mtihani_app/ui/views/student_classes/student_classes_viewmodel.dart';
...
class StudentClassesView extends StackedView<StudentClassesViewModel> {
              ...
              ? Column(
                  ...
                  children: [
                    ...
                    buildPriBtn(
                      ...
                      onAction: viewModel.onJoinClass,
                    ),
                  ],
                )
  ...
  @override
  StudentClassesViewModel viewModelBuilder(
    BuildContext context,
  ) =>
